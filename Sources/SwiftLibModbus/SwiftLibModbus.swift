...
class SwiftLibModbus: NSObject {
    ...
    let modbusQueue = DispatchQueue(label: "com.iModbus.modbusQueue", attributes: .concurrent)
    ...
    func connectWithError(_ error: inout NSError) -> Bool {
